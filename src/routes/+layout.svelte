...
<div
    ...
    <nav
        class="grid grid-cols-3 fixed {currentPlatform === 'android' || currentPlatform === 'ios' ? 'bottom-3 shadow-[0_5rem_0_5rem] shadow-gray-100 dark:shadow-gray-900' : 'bottom-0'} left-0 right-0 justify-between z-10 w-full h-20 p-2 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 lg:hidden">
        <a
            href="/"
