...
<div
    class="relative min-h-dvh w-full overflow-y-auto flex flex-col items-center gap-4 {currentPlatform === 'android' || currentPlatform === 'ios' ? 'pt-16 pb-3' : 'pt-4'} md:pt-16 md:gap-8 px-4 bg-gray-100 dark:bg-gray-900">
